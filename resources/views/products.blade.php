...
<h1 style="text-align: center ; margin-top : 50px"> All Product</h1>
			...
			<div class="col-lg-3 blog-form p-5">
				...
				<div class="input-group mb-3">
					<div style="width: 100%" >
						...
						<input style="width:75%" type="range" name="condition" id="" placeholder="Condition" min="1" max="100"  oninput="this.nextElementSibling.value = this.value " />
						<output>50</output>
						<label >%</label>
					</div>				
