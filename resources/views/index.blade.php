...
@section('content')
    ...
    <section id="product1" class="section-p1">
        ...
        <div id="down" class="pro-container">
            <div class="pro">
        ...
        <div class="container">
            <div class="row">
                <div class="footer-col-1">
                    ...
                    <div class="app-logo">
                        <img src="{{ asset('storage/prod_image/play-store.png') }}">
                        <img src="{{ asset('storage/prod_image/app-store.png') }}">
                    </div>
                </div>
                <div class="footer-col-2">
                    <img src="{{ asset('storage/prod_image/logo.png') }}">
